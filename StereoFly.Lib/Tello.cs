...
namespace StereoFly.TelloLib
{
    // source: https://github.com/Kragrathea/TelloLib/blob/master/TelloLib/Tello.cs
    public class Tello
    {
        ...
        */
        ...
        private static uint picBytesRecived;
        private static uint picBytesExpected;
        private static uint picExtraPackets;
                        ...
                        if (cmdId == 99)//jpeg
                        {
                            ...
                            if (!picChunkState[seqNum])
                            {
                                ...
                                if (picFilePath != null && picBytesRecived >= picBytesExpected)
                                {
                                    ...
                                    sendAckFilePiece(1, 0, (uint)maxPieceNum);//todo. Double check this. finalize
